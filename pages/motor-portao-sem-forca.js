...
export default function MotorPortaoSemForca() {
 ...
 useEffect(() => {
  ...
  return (
                                                  ...
                                                  <title>
                                                  Motor do Portão Sem Força? Assistência Técnica | TecCasa Soluções
                                                  </title>
                                                  
                                                  <meta
                                                  name="description"
                                                  content="O motor do portão está sem força, lento ou pára a meio? Diagnóstico de condensador, esforço mecânico, calhas, dobradiças, afinação, motor e automatismos."
                                                  />
                                                  
                                                  <meta
                                                  name="keywords"
                                                  content="motor portão sem força,
                                                  motor do portão fraco,
                                                  portão automático sem força,
                                                  motor portão não tem força,
                                                  portão automático abre devagar,
                                                  portão automático lento,
                                                  portão precisa de ajuda para abrir,
                                                  condensador motor portão,
                                                  motor garagem sem força,
                                                  reparação motor portão,
                                                  TecCasa Soluções"
                                                  />
                                                  
                                                  <meta name="viewport" content="width=device-width, initial-scale=1" />
                                                  
                                                  <meta property="og:title" content="Motor do Portão Sem Força? | TecCasa Soluções" />
                                                  
                                                  <meta
                                                  property="og:description"
                                                  content="Assistência técnica para motores de portão que perderam força, abrem devagar, param a meio ou têm dificuldade em movimentar o portão."
                                                  />
                                                  ...
                                                  <meta
                                                  property="og:url"
                                                  content="https://tec-casa.pt/motor-portao-sem-forca"
                                                  />
                                                  ...
                                                  <link rel="canonical" href="https://tec-casa.pt/motor-portao-sem-forca" />
  ...
  >
    ...
    >
      ...
      <div className="main-card">
                    ...
                    O motor do portão está sem força?
                    </h1>
                    ...
                    Quando o motor do portão começa a abrir devagar, pára a meio,
                    precisa de ajuda para movimentar o portão ou parece não ter força suficiente,
                    a causa pode estar no condensador, no esforço mecânico, na afinação ou no desgaste do automatismo.
                    </p>
                    ...
                    <img
                    src="/motor-portao-sem-forca-hero.png"
                    alt="Motor do portão sem força"
                    style={{
                    width:"100%",
                    maxWidth:"600px",
                    borderRadius:"28px",

  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Automatic gate installation in Lisbon for sliding gates, swing gates and selected garage doors. Gate motor replacement and residential gate automation."
        />
      
        <meta
          name="keywords"
          content="automatic gate installation Lisbon, gate automation Lisbon, electric gate installation Lisbon, sliding gate motor Lisbon, swing gate motor Lisbon, garage door motor installation Lisbon, TecCasa Soluções"
        />
        ...
        <meta
          property="og:title"
          content="Automatic Gate Installation in Lisbon | TecCasa Soluções"
        />
      
        <meta
          property="og:description"
          content="Installation and replacement of automatic gate motors for residential gates in Lisbon and surrounding areas."
        />
      ...
      <div className="page">
        ...
        <main className="main-card">
          <section className="hero-reparacao">
            <div>
              <div className="eyebrow">Automatic gate installation in Lisbon</div>
          
              <h1>Gate motor installation and replacement in Lisbon</h1>
          
              <p className="lead">
                TecCasa Soluções installs and replaces automatic gate motors for residential
                sliding gates, swing gates and selected garage doors in Lisbon and surrounding areas.
              </p>
          
              <p className="support">
                We focus on suitable, reliable solutions for the type of gate, daily use,
                safety conditions and existing electrical setup.
              </p>
            ...
            <div className="hero-image-wrap">
              <img
                src="/portao.png"
                alt="Automatic gate installation in Lisbon"
              />
            </div>
          </section>

  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Domestic security camera installation in Lisbon for homes, apartments and holiday properties. Simple remote monitoring solutions for residential use."
        />
      
        <meta
          name="keywords"
          content="security camera installation Lisbon, home security cameras Lisbon, domestic cameras Lisbon, holiday home monitoring Lisbon, CCTV Lisbon residential, smart cameras Lisbon, TecCasa Soluções"
        />
        ...
        <meta
          ...
          content="Installation of domestic security cameras and simple remote monitoring solutions for homes and holiday properties in Lisbon and surrounding areas."
        />
      ...
      <div className="page">
        ...
        <main className="main-card">
          <section className="hero-reparacao">
            <div>
              <div className="eyebrow">Domestic security cameras in Lisbon</div>
          
              <h1>Security camera installation for homes and holiday properties</h1>
          
              <p className="lead">
                TecCasa Soluções installs simple domestic security camera systems for
                homes, apartments and holiday properties in Lisbon and surrounding areas.
              </p>
          
              <p className="support">
                Ideal for homeowners who want to monitor entrances, garages, patios or
                holiday homes remotely, with practical solutions for residential use.
              </p>
            ...
            <div className="hero-image-wrap">
              <img
                src="/vigilancia.png"
                alt="Domestic security camera installation in Lisbon"
              />
            </div>
          </section>

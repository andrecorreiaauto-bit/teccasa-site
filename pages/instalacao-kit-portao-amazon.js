...
export default function InstalacaoKitPortaoAmazon() {
 ...
 useEffect(() => {
  ...
  return (
                                                  ...
                                                  <title>
                                                  Instalação de Kit de Portão Amazon | TecCasa Soluções
                                                  </title>

                                                  <meta
                                                  name="description"
                                                  content="Comprou um kit de automatismo para portão na Amazon? A TecCasa Soluções pode avaliar o equipamento e instalar quando existirem condições técnicas, compatibilidade e segurança."
                                                  />

                                                  <meta
                                                  name="keywords"
                                                  content="instalação kit portão Amazon,
                                                  instalar automatismo Amazon,
                                                  kit portão automático Amazon,
                                                  motor portão Amazon,
                                                  automatismo portão Amazon,
                                                  instalação motor portão comprado na Amazon,
                                                  kit portão comprado na Amazon, automatismo comprado na Amazon, motor portão comprado online,
                                                  TecCasa Soluções"
                                                  />

                                                  <meta name="viewport" content="width=device-width, initial-scale=1" />

                                                  <meta property="og:title" content="Instalação de Kit de Portão Amazon | TecCasa Soluções" />

                                                  <meta
                                                  property="og:description"
                                                  content="Avaliação e instalação de kits de automatismo para portão comprados na Amazon, mediante compatibilidade, equipamento completo e condições de segurança. Serviço técnico independente, sem representação oficial da Amazon."
                                                  />
                                                  ...
                                                  <meta
                                                  property="og:url"
                                                  content="https://tec-casa.pt/instalacao-kit-portao-amazon"
                                                  />
                                                  ...
                                                  <link rel="canonical" href="https://tec-casa.pt/instalacao-kit-portao-amazon" />
  ...
  >
    ...
    >
      ...
      <div className="main-card">
                    ...
                    Kit comprado na <span style={{color:"#ff9900"}}>Amazon</span>
                    </div>
                    ...
                    Instalação de kit de portão comprado na Amazon
                    </h1>
                    ...
                    Comprou um kit de automatismo para portão na Amazon e precisa de instalação?
                    ...
                    alt="Instalação de kit de automatismo para portão comprado na Amazon"
                    style={{
                    width:"100%",
                    maxWidth:"600px",
                    borderRadius:"28px",

...
export default function AutomatismosDeaPortoes() {
 ...
 useEffect(() => {
  ...
  return (
                                                  ...
                                                  <title>
                                                  Automatismos DEA para Portões | Instalação e Assistência | TecCasa Soluções
                                                  </title>
                                                  
                                                  <meta
                                                  name="description"
                                                  content="Instalação, programação, substituição e assistência técnica a automatismos DEA para portões de correr, batente e garagem. Diagnóstico de motores, comandos, centrais e segurança."
                                                  />
                                                  
                                                  <meta
                                                  name="keywords"
                                                  content="automatismos DEA,
                                                  portões DEA,
                                                  instalação DEA portões,
                                                  reparação DEA portões,
                                                  assistência DEA,
                                                  motor DEA portão,
                                                  comandos DEA,
                                                  central DEA,
                                                  ...
                                                  <meta property="og:title" content="Automatismos DEA para Portões | TecCasa Soluções" />
                                                  
                                                  <meta
                                                  property="og:description"
                                                  content="Instalação, programação e assistência técnica a automatismos DEA para portões automáticos residenciais, acessos exteriores e pequenos condomínios."
                                                  />
                                                  ...
                                                  <meta
                                                  property="og:url"
                                                  content="https://tec-casa.pt/automatismos-dea-portoes"
                                                  />
                                                  ...
                                                  <link rel="canonical" href="https://tec-casa.pt/automatismos-dea-portoes" />
  ...
  >
    ...
    >
      ...
      <div className="main-card">
                    ...
                    Instalação, programação e assistência técnica a automatismos DEA
                    ...
                    Serviço técnico independente para automatismos DEA.
                    </p>
                    ...
                    <img
                    src="/automatismos-dea-portoes-hero.png"
                    alt="Instalação e assistência a automatismos DEA para portões"
                    style={{
                    width:"100%",
                    maxWidth:"600px",
                    borderRadius:"28px",

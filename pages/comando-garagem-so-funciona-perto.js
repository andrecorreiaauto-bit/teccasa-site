...
export default function ComandoGaragemSoFuncionaPerto() {
 ...
 useEffect(() => {
  ...
  return (
                                                  ...
                                                  <title>
                                                  Comando da Garagem Só Funciona Perto? | TecCasa Soluções
                                                  </title>
                                                  
                                                  <meta
                                                  name="description"
                                                  content="O comando da garagem só funciona muito perto do portão? Diagnóstico de pilha fraca, antena, recetor RF, interferências, programação e automatismos multimarca."
                                                  />
                                                  
                                                  <meta
                                                  name="keywords"
                                                  content="comando garagem só funciona perto,
                                                  comando portão só abre de perto,
                                                  comando garagem pouco alcance,
                                                  comando portão automático fraco,
                                                  recetor RF portão,
                                                  antena portão automático,
                                                  comando garagem falha sinal,
                                                  reparação comandos garagem,
                                                  automatismos,
                                                  TecCasa Soluções"
                                                  />
                                                  ...
                                                  <meta property="og:title" content="Comando da Garagem Só Funciona Perto? | TecCasa Soluções" />
                                                  
                                                  <meta
                                                  property="og:description"
                                                  content="Assistência técnica para comandos de garagem com pouco alcance, falhas de sinal, recetores RF e automatismos residenciais."
                                                  />
                                                  ...
                                                  <meta
                                                  property="og:url"
                                                  content="https://tec-casa.pt/comando-garagem-so-funciona-perto"
                                                  />
                                                  ...
                                                  <link rel="canonical" href="https://tec-casa.pt/comando-garagem-so-funciona-perto" />
  ...
  >
    ...
    >
      ...
      <div className="main-card">
                  ...
                  O comando da garagem só funciona perto?
                  </h1>
                  ...
                  Quando o comando só abre o portão a poucos metros, o problema pode estar na pilha,
                  na antena, no recetor RF, em interferências ou numa falha de programação do automatismo.
                  </p>
                  ...
                  <img
                  src="/comando-garagem-so-funciona-perto-hero.png"
                  alt="Comando da garagem só funciona perto"
                  style={{
                  width:"100%",
                  maxWidth:"600px",
                  borderRadius:"28px",

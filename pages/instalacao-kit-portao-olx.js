...
export default function InstalacaoKitPortaoOlx() {
 ...
 useEffect(() => {
  ...
  return (
                                                  ...
                                                  <title>
                                                  Instalação de Kit de Portão OLX | TecCasa Soluções
                                                  </title>

                                                  <meta
                                                  name="description"
                                                  content="Comprou um kit de automatismo para portão no OLX? A TecCasa Soluções pode avaliar o equipamento e instalar quando existirem condições técnicas, compatibilidade e segurança."
                                                  />

                                                  <meta
                                                  name="keywords"
                                                  content="instalação kit portão OLX,
                                                  instalar automatismo OLX,
                                                  kit portão automático OLX,
                                                  motor portão OLX,
                                                  automatismo portão OLX,
                                                  instalação motor portão comprado no OLX,
                                                  kit portão comprado no OLX, automatismo usado OLX, motor portão usado, instalação motor portão comprado online,
                                                  TecCasa Soluções"
                                                  />

                                                  <meta name="viewport" content="width=device-width, initial-scale=1" />

                                                  <meta property="og:title" content="Instalação de Kit de Portão OLX | TecCasa Soluções" />

                                                  <meta
                                                  property="og:description"
                                                  content="Avaliação e instalação de kits de automatismo para portão comprados no OLX, mediante compatibilidade, equipamento completo e condições de segurança. Especial atenção a equipamento usado, incompleto ou sem documentação."
                                                  />
                                                  ...
                                                  <meta
                                                  property="og:url"
                                                  content="https://tec-casa.pt/instalacao-kit-portao-olx"
                                                  />
                                                  ...
                                                  <link rel="canonical" href="https://tec-casa.pt/instalacao-kit-portao-olx" />
  ...
  >
    ...
    >
      ...
      <div className="main-card">
                    ...
                    border:"1px solid rgba(35,229,219,0.28)",
                    marginBottom:"20px"
                    }}>
                    Kit comprado no <span style={{color:"#00b8b0"}}>OLX</span>
                    </div>
                    ...
                    Instalação de kit de portão comprado no OLX
                    </h1>
                    ...
                    Comprou um kit de automatismo para portão no OLX e precisa de instalação?
                    A TecCasa Soluções pode avaliar o equipamento, verificar as condições do portão
                    e instalar quando existirem condições técnicas e de segurança.
                    </p>
                    ...
                    A instalação depende do kit estar completo, em bom estado, ser compatível com o portão,
                    existir alimentação elétrica adequada e o portão apresentar boas condições mecânicas.
                    </p>
                    ...
                    <a
                    href="https://wa.me/351922021980?text=Ol%C3%A1%2C%20comprei%20um%20kit%20de%20automatismo%20para%20port%C3%A3o%20no%20OLX%20e%20gostava%20de%20saber%20se%20%C3%A9%20poss%C3%ADvel%20instalar.%20Posso%20enviar%20fotos."
                    target="_blank"
                    style={{
                    ...
                    alt="Instalação de kit de automatismo para portão comprado no OLX"
                    style={{
                    width:"100%",
                    maxWidth:"600px",
                    borderRadius:"28px",
                    ...
                    />
                                           ...
                                           Antes de instalar um kit de automatismo para portão comprado no OLX, confirmamos se o equipamento está completo, em bom estado, adequado ao portão e se existem condições técnicas e de segurança para avançar com a montagem.
                                           </p>
                                           ...
                                           {[
                                           {
                                           title:"Kit completo e em bom estado",
                                           text:"Verificamos se o kit inclui motor, central, comandos, fotocélulas, suportes, acessórios, manual e se não apresenta sinais evidentes de danos."
                                           },
                                           ...
                                           text:"Alguns kits comprados no OLX podem estar usados, incompletos, sem manual, sem acessórios, sem garantia ou com desgaste que impeça uma instalação segura."
                                           }
                                           ...
                                           {item.text}
                                                              ...
                                                              Comprou um kit no <span style={{color:"#00b8b0"}}>OLX</span>?
                                                              </h2>
                                                              ...
                                                              Se comprou um kit de automatismo para portão no OLX, envie fotografias da caixa, dos motores, acessórios, cabos, central, comandos e do portão. A TecCasa Soluções pode fazer uma primeira avaliação e indicar se existem condições para instalação.
                                                              </p>
                                                              ...
                                                              Em equipamentos comprados no OLX, é especialmente importante confirmar o estado do material, se faltam peças, se existe manual e se o motor não apresenta sinais de desgaste, avaria ou incompatibilidade.
                                                              </p>
                                                              ...
                                                              A TecCasa Soluções é um serviço técnico independente. Não representa oficialmente o OLX, anunciantes, vendedores, nem qualquer marca ou fabricante dos kits vendidos ou anunciados na plataforma.
                                                              </p>

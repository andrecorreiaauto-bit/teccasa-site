...
export default function ComandoGaragemNaoFunciona() {
...
gap:"10px"
  ...
  <a
  href="/en/gate-remote-control-not-working"
  style={{
  color:"#08285c",
  textDecoration:"none",
  fontWeight:"bold",
    ...
    >
      ...
      <div className="main-card">
                  ...
                  <section
                   ...
                   O comando da garagem deixou de funcionar?
                   </h1>
                   ...
                   Diagnóstico de comandos de garagem e portões automáticos, recetores RF, programação e sistemas de abertura automática.
                   </p>
                   ...
                   alt="Comando de garagem não funciona"
                   style={{
                   width:"100%",
                   maxWidth:"600px",
                   borderRadius:"28px",

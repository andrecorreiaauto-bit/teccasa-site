...
export default function AutomatismosBftPortoes() {
 ...
 useEffect(() => {
  ...
  return (
                                                  ...
                                                  <title>
                                                  Automatismos BFT para Portões | Instalação e Assistência | TecCasa Soluções
                                                  </title>
                                                  
                                                  <meta
                                                  name="description"
                                                  content="Instalação, programação, substituição e assistência técnica a automatismos BFT para portões de correr, batente e garagem. Diagnóstico de motores, centrais, comandos e sistemas de segurança."
                                                  />
                                                  
                                                  <meta
                                                  name="keywords"
                                                  content="automatismos BFT,
                                                  portões BFT,
                                                  instalação BFT portões,
                                                  reparação BFT portões,
                                                  assistência BFT,
                                                  motor BFT portão,
                                                  comandos BFT,
                                                  central BFT,
                                                  ...
                                                  <meta property="og:title" content="Automatismos BFT para Portões | TecCasa Soluções" />
                                                  
                                                  <meta
                                                  property="og:description"
                                                  content="Instalação, programação e assistência técnica a automatismos BFT para portões automáticos residenciais e acessos exteriores."
                                                  />
                                                  ...
                                                  <meta
                                                  property="og:url"
                                                  content="https://tec-casa.pt/automatismos-bft-portoes"
                                                  />
                                                  ...
                                                  <link rel="canonical" href="https://tec-casa.pt/automatismos-bft-portoes" />
  ...
  >
    ...
    >
      ...
      <div className="main-card">
                    ...
                    Instalação, programação e assistência técnica a automatismos BFT
                    ...
                    Serviço técnico independente para automatismos BFT.
                    </p>
                    ...
                    <img
                    src="/automatismos-bft-portoes-hero.png"
                    alt="Instalação e assistência a automatismos BFT para portões"
                    style={{
                    width:"100%",
                    maxWidth:"600px",
                    borderRadius:"28px",

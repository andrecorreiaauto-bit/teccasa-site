...
export default function AutomatismosHormannPortoes() {
 ...
 useEffect(() => {
  ...
  return (
                                                  ...
                                                  <title>
                                                  Automatismos Hörmann para Portões | Instalação e Assistência | TecCasa Soluções
                                                  </title>
                                                  
                                                  <meta
                                                  name="description"
                                                  content="Instalação, programação, substituição e assistência técnica a automatismos Hörmann para portões de garagem, portões de correr e batente. Diagnóstico de motores, comandos, centrais e segurança."
                                                  />
                                                  
                                                  <meta
                                                  name="keywords"
                                                  content="automatismos Hörmann,
                                                  automatismos Hormann,
                                                  portões Hörmann,
                                                  portões Hormann,
                                                  instalação Hörmann portões,
                                                  reparação Hörmann portões,
                                                  assistência Hörmann,
                                                  motor Hörmann portão,
                                                  comandos Hörmann,
                                                  central Hörmann,
                                                  motor portão garagem Hörmann,
                                                  TecCasa Soluções"
                                                  />
                                                  
                                                  <meta name="viewport" content="width=device-width, initial-scale=1" />
                                                  
                                                  <meta property="og:title" content="Automatismos Hörmann para Portões | TecCasa Soluções" />
                                                  
                                                  <meta
                                                  property="og:description"
                                                  content="Instalação, programação e assistência técnica a automatismos Hörmann para portões de garagem, portões automáticos residenciais e acessos exteriores."
                                                  />
                                                  ...
                                                  <meta
                                                  property="og:url"
                                                  content="https://tec-casa.pt/automatismos-hormann-portoes"
                                                  />
                                                  ...
                                                  <link rel="canonical" href="https://tec-casa.pt/automatismos-hormann-portoes" />
  ...
  >
    ...
    >
      ...
      <div className="main-card">
                    ...
                    Automatismos Hörmann para portões
                    </h1>
                    ...
                    Instalação, programação e assistência técnica a automatismos Hörmann
                    para portões de garagem, portões de correr e portões de batente.
                    ...
                    Serviço técnico independente para automatismos Hörmann.
                    </p>
                    ...
                    <img
                    src="/automatismos-hormann-portoes-hero.png"
                    alt="Instalação e assistência a automatismos Hörmann para portões"
                    style={{
                    width:"100%",
                    maxWidth:"600px",
                    borderRadius:"28px",
                    ...
                    />
                                           ...
                                           Serviços em automatismos Hörmann
                                           </h2>
                                           ...
                                           A TecCasa Soluções presta instalação, programação e assistência técnica a automatismos Hörmann,
                                           com foco em portões de garagem, portões seccionados, comandos, motores de teto,
                                           afinação de funcionamento e diagnóstico de avarias.
                                           </p>
                                           ...
                                           {[
                                           {
                                           title:"Instalação de motores Hörmann",
                                           text:"Montagem de automatismos Hörmann em portões de garagem, portões seccionados e outros sistemas residenciais compatíveis."
                                           },
                                           
                                           {
                                           title:"Programação de comandos",
                                           text:"Configuração de comandos, recetores, abertura automática e parâmetros de utilização diária."
                                           },
                                           
                                           {
                                           title:"Diagnóstico de avarias",
                                           text:"Análise de falhas em motores de teto, comandos, centrais, sensores, cablagem e sistemas de segurança."
                                           },
                                           
                                           {
                                           title:"Substituição e afinação",
                                           text:"Substituição de motores antigos, afinação de funcionamento e verificação do estado mecânico do portão."
                                           }
                                           ...
                                           {item.text}
                                                              ...
                                                              Problemas comuns em automatismos Hörmann
                                                              </h2>
                                                              ...
                                                              Se o seu portão com automatismo Hörmann deixou de funcionar corretamente,
                                                              ...
                                                              text:"Quando o motor de teto não abre o portão de garagem ou o portão fica bloqueado."
                                                              },
                                                              ...
                                                              text:"Quando o comando tem pouco alcance ou só funciona muito perto da garagem."
                                                              },
                                                              ...
                                                              text:"Quando o motor perde força, o portão sobe com dificuldade ou para durante o movimento."
                                                              },
                                                              ...
                                                              Saber mais
                                                                                         ...
                                                                                         Precisa de ajuda com um automatismo Hörmann?
                                                                                         </h2>
                                                                                         ...
                                                                                         Se tem um motor Hörmann instalado, precisa de programar comandos,
                        ...
                        {/* NOVA PÁGINA AQUI */}
                                                           ...
                                                           Ver zona de atuação da TecCasa Soluções
                                                                                      ...
                                                                                      Serviço técnico independente. A TecCasa Soluções presta instalação, programação e assistência a automatismos Hörmann.
                                                                                      </p>

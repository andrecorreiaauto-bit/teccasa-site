...
export default function AutomatismosV2Portoes() {
 ...
 useEffect(() => {
  ...
  return (
                                                  ...
                                                  <title>
                                                  Automatismos V2 para Portões | Instalação e Assistência | TecCasa Soluções
                                                  </title>
                                                  
                                                  <meta
                                                  name="description"
                                                  content="Instalação, programação, substituição e assistência técnica a automatismos V2 para portões de correr, batente e garagem. Diagnóstico de motores, comandos, centrais e segurança."
                                                  />
                                                  
                                                  <meta
                                                  name="keywords"
                                                  content="automatismos V2,
                                                  portões V2,
                                                  instalação V2 portões,
                                                  reparação V2 portões,
                                                  assistência V2,
                                                  motor V2 portão,
                                                  comandos V2,
                                                  central V2,
                                                  ...
                                                  <meta property="og:title" content="Automatismos V2 para Portões | TecCasa Soluções" />
                                                  
                                                  <meta
                                                  property="og:description"
                                                  content="Instalação, programação e assistência técnica a automatismos V2 para portões automáticos residenciais, acessos exteriores e garagens."
                                                  />
                                                  ...
                                                  <meta
                                                  property="og:url"
                                                  content="https://tec-casa.pt/automatismos-v2-portoes"
                                                  />
                                                  ...
                                                  <link rel="canonical" href="https://tec-casa.pt/automatismos-v2-portoes" />
  ...
  >
    ...
    >
      ...
      <div className="main-card">
                    ...
                    Instalação, programação e assistência técnica a automatismos V2
                    ...
                    Serviço técnico independente para automatismos V2.
                    </p>
                    ...
                    <img
                    src="/automatismos-v2-portoes-hero.png"
                    alt="Instalação e assistência a automatismos V2 para portões"
                    style={{
                    width:"100%",
                    maxWidth:"600px",
                    borderRadius:"28px",
                    ...
                    />
                                           ...
                                           A TecCasa Soluções presta instalação, programação e assistência técnica a automatismos V2,
                                           ...
                                           {[
                                           {
                                           title:"Instalação de motores V2",
                                           text:"Montagem de automatismos V2 em portões de correr, batente e garagem, com verificação prévia das condições do portão."
                                           },
                                           ...
                                           {item.text}
                                                              ...
                                                              Problemas comuns em automatismos V2
                                                              </h2>
                                                              ...
                                                              Se o seu portão com automatismo V2 deixou de funcionar corretamente,
                                                              ...
                                                              Saber mais
                                                                                         ...
                                                                                         Precisa de ajuda com um automatismo V2?
                                                                                         </h2>
                                                                                         ...
                                                                                         Se tem um motor V2 instalado, precisa de programar comandos,
                        ...
                        {/* NOVA PÁGINA AQUI */}
                                                           ...
                                                           Ver zona de atuação da TecCasa Soluções
                                                                                      ...
                                                                                      Serviço técnico independente. A TecCasa Soluções presta instalação, programação e assistência a automatismos V2.
                                                                                      </p>
